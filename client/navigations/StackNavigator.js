  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen name="Payment" component={PaymentMethodScreen} options={{ headerShown: false }} />
        <Stack.Screen name="PlaceOrder" component={PlaceOrderScreen} options={{ headerShown: false }} />
